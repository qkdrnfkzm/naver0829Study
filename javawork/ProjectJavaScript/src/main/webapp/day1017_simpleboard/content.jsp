...
<%
	...
	List<AnswerBoardDto> alist = adao.getAnswerBoard(num);
%>
<body>
	<div style="margin: 30px 50px">
		<table class="table table-bordered" style="width: 500px;">
			...
			<tr height="300" valign="top">
				<td>
					<!-- 여러줄일경우 replace 로 \n을 <br>로 변경하거나 아니면 <pre> 태그로 출력으르 해야만 줄넘김이 된다 --> 
				...
				<td>
					...
					<%
						for(AnswerBoardDto adto : alist){%>
							...
							<!-- 삭제 아이콘 -->
							&nbsp;&nbsp;
							<i class="bi bi-trash answerdel" style="cursor: pointer;" idx="<%=adto.getIdx()%>" num="<%=adto.getNum()%>"></i>
							<br>
						<%}
					%>
					</div>
			...
			<tr>
				<td align="center">
					...
					<button type="button" class="btn btn-outline-success"
						style="width: 100px;"
						onclick="location.href='boarddelete.jsp?num=<%=dto.getNum()%>'">삭제</button>
				</td>
			</tr>
		</table>
	</div>
